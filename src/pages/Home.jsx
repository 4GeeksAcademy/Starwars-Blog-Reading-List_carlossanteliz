...
export const Home = () => {
  ...
  async function people() {
    ...
    try {
      ...
      localStorage.setItem("store", JSON.stringify({ ...store, people: personajesBasicos }));
    } catch (err) {
  ...
  async function fetchVehicles() {
    ...
    try {
      ...
      localStorage.setItem("vehicles", JSON.stringify(vehiculosBasicos));
    } catch (err) {
  ...
  async function fetchStarships() {
    ...
    try {
      ...
      localStorage.setItem("starships", JSON.stringify(starshipsBasicos));
    } catch (err) {
  ...
  return (
    <div className="text-center mt-5">
      ...
      <h2 className="text-warning fw-bold my-4">People</h2>
      ...
      <h2 className="text-warning fw-bold my-4">Vehicles</h2>
      ...
      <h2 className="text-warning fw-bold my-4">Starships</h2>
